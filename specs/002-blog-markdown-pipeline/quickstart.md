...
4. Run the generator locally to verify the card appears in blog listing.
...
2. Click Read more and confirm article.html opens with rendered content.
3. Verify dark and light themes on both pages.
4. Verify missing or invalid article links show a friendly error state.
